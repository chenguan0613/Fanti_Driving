    ...
    return jsonify(
        {
            ...
            "eye_state": predictor.eye_state,
            "mouth_state": predictor.mouth_state,
            "hand_state": predictor.hand_state,
            "hand_count": predictor.hand_count,
            "yawns_per_minute": len(predictor.yawn_events),
        }
    )
